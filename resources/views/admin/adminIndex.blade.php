...
<body class="antialiased bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <section id="faq" class="py-20 bg-gray-100 dark:bg-gray-800">
        <div class="container mx-auto px-6">
            <h2 class="text-3xl font-bold text-center mb-12 text-gray-800 dark:text-white">FAQ</h2>
            <div class="max-w-3xl mx-auto text-center mb-12">
                <p class="text-gray-600 dark:text-gray-300 mb-6">Berikut adalah pertanyaan yang sering diajukan terkait
                    PendataX. Klik pada setiap pertanyaan untuk melihat jawabannya.</p>
            </div>
    ...
    <section id="testimonial" class="py-20 bg-gray-100 dark:bg-gray-800">
        <div class="container mx-auto px-6">
            <h2 class="text-4xl font-bold text-center mb-10 text-gray-800 dark:text-white">Apa yang Mereka Katakan
                Tentang Kami</h2>
